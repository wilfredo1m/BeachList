...
public class ReportedScreen extends AppCompatActivity {
    Button backButton;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reported_screen);

        //initializing tabs and pager
        tabLayout = findViewById(R.id.reported_tab_selection);
        //TabItem currentTab = findViewById(R.id.current_tab);
        //TabItem soldTab = findViewById(R.id.sold_tab);
        viewpager = findViewById(R.id.reported_pager);

        ReportedFragmentCollectionAdapter pagerAdapter= new
                ReportedFragmentCollectionAdapter(getSupportFragmentManager(),tabLayout.getTabCount());
...
//****************************************Back Button and Accept/Reject Buttons****************************************************//
        backButton = findViewById(R.id.btn_back_from_reported);
...
//**************************************************END BUTTON GROUP**************************************************************//
    ...
    public int checkTabCall()
    {
        ...
        tabPosition= getIntent().getIntExtra("reportedPageTab",7);
        return tabPosition;
